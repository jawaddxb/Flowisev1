...
import { Box, AppBar, Toolbar, Button, TextField, Dialog, DialogTitle, DialogContent, DialogActions, Alert } from '@mui/material'
import { useTheme } from '@mui/material/styles'
import { IconDeviceFloppy, IconPlayerPlay, IconArrowLeft, IconPlus } from '@tabler/icons-react'
...
class ErrorBoundary extends React.Component {
    ...
    componentDidCatch(error, errorInfo) {
        console.error("Uncaught error in OrchestratorCanvas:", error, errorInfo)
    }

    render() {
        if (this.state.hasError) {
            return (
                <Box sx={{ p: 4, m: 4, border: '2px dashed red' }}>
                    <Alert severity='error'>
                        <h1>Something went wrong in OrchestratorCanvas</h1>
    ...
    const handleSave = async () => {
        ...
        try {
            if (id) {
                ...
                navigate(`/orchestrator/canvas/${createResp.data.id}`)
            }
